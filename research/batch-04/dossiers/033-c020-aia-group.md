...
2. **Agent assistance/personalization (generative assistance).** Policy/customer context can surface next actions and draft explanations, potentially increasing active-agent capacity, conversion and persistency. Advice suitability and hallucination checks impose review. AIA reports straight-through processing rising from 22% in June 2020 to 73% in December 2024, auto-adjudication from 41% to 75%, 97% OCR accuracy, review time halved and rollout across four markets. These are company-authored before/after operating metrics without a control; bundled workflow redesign and time trends confound attribution, and leakage, appeals and retained cash are undisclosed: E2.
