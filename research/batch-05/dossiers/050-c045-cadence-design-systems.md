...
The 5% hurdle uses a labeled reported-profit scale because normalized post-transaction profit is unavailable: $22.493m per $449.856m quarterly GAAP operating-profit scale, or $89.971m annualized with a seasonality caveat. Illustrative cost bridge: $800m eligible cost × 15% × 60% × 50% − $50m = **−$14m**. All inputs are assumptions and customer engineering savings are not vendor cost. A revenue bridge must use incremental contribution after displaced seats, discounts, cloud compute and support.
