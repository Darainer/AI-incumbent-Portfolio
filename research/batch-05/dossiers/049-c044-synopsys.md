# C044 — Synopsys evidence dossier

**Unreviewed agent work.** Synopsys; Nasdaq common stock SNPS, USD quote/reporting. Cutoff/retrieval 12 September 2026. Latest period: Q3 FY2026 ended July 2026, published 26 August 2026.

## Business and financial anchor

Synopsys sells electronic-design-automation software, verification hardware/software and semiconductor IP into chip and system design. Recurring time-based licenses, maintenance and IP royalties are supported by high switching cost, foundry certification and signoff risk. FY2025 revenue above $7bn; Ansys acquisition changed the perimeter. The latest release reported revenue **$2.477bn** and **GAAP EPS $2.84**. The source is [Synopsys latest results](https://news.synopsys.com/2026-08-26-Synopsys-Posts-Financial-Results-for-Third-Quarter-Fiscal-Year-2026). Reported versus non-GAAP measures must stay separate; deferred revenue, backlog, acquisition accounting and hardware timing can move quarterly margins and cash.

Its scarce assets are decades of algorithms, foundry-qualified flows, reusable IP, installed customer workflows and design telemetry. DSO.ai and autonomous engineering workflows optimize power, performance and area and orchestrate verification. However, chip designs, PDKs and much IP belong to customers, foundries or licensors. Therefore technical access is not universal training permission. Conventional resilience depends on semiconductor R&D intensity and oligopoly, while export controls, customer consolidation and integration are key risks. The Ansys acquisition adds debt, integration and accounting complexity; 2025 US export controls temporarily forced guidance suspension.
...
The Q3 release reports **$357.491m consolidated GAAP operating income** for the quarter and **$680.963m for nine months** after the Ansys perimeter change. The same-period 5% hurdles are therefore **$17.875m for Q3** and **$34.048m for nine months**; neither is annualized. Illustrative cost bridge: $1.0bn eligible R&D/support cost × 15% × 60% × 50% − $60m = −$15m. The cost illustration is annual while the hurdles are quarterly/nine-month; it is **NOT_COMPARABLE** without time alignment. All inputs are assumptions and customer engineering savings are not vendor cost. A revenue bridge must use incremental contribution after displaced seats, discounts, cloud compute and support.
...
Opened 12 Sep 2026: [latest results](https://news.synopsys.com/2026-08-26-Synopsys-Posts-Financial-Results-for-Third-Quarter-Fiscal-Year-2026) (financial period above); [SEC filings](https://www.sec.gov/edgar/browse/?CIK=883241) (annual/quarterly financial and IP risks); [Synopsys.ai](https://www.synopsys.com/ai.html) (product scope); [Nvidia-Synopsys collaboration](https://nvidianews.nvidia.com/news/nvidia-synopsys-partnership) (1 Dec 2025, explicitly nonexclusive); [Siemens EDA](https://eda.sw.siemens.com/en-US/ic/) (substitute); [U.S. BIS](https://www.bis.gov/) (export-control authority); [IEEE 1735 security study](https://arxiv.org/abs/2112.04838) (third-party research, 2021, IP protection adverse); [Cadence Cerebrus](https://www.cadence.com/en_US/home/ai.html) (challenger). Some customer contracts and product metrics were inaccessible; unknowns remain explicit.

Handoff [c044.json](../capsules/c044.json). Verify latest GAAP/non-GAAP reconciliation, rights language for customer/third-party IP, and whether named benchmarks control compute/human/signoff quality. Research-only; G2 incomplete.
...
Ansys integration must also be isolated: simulation cross-sell and purchase accounting can explain revenue or margin shifts without any AI productivity change.
