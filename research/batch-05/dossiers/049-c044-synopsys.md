...
The 5% hurdle uses a labeled reported-profit scale because normalized post-transaction profit is unavailable: $25m per $500m normalized operating profit proxy. Illustrative cost bridge: $1.0bn eligible R&D/support cost × 15% × 60% × 50% − $60m = −$15m. All inputs are assumptions and customer engineering savings are not vendor cost. A revenue bridge must use incremental contribution after displaced seats, discounts, cloud compute and support.
