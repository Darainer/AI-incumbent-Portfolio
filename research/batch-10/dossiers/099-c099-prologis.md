# C099 — Prologis evidence dossier

**Unreviewed agent work.** Prologis; PLD (NYSE, USD quote/reporting). Cutoff/retrieval 12 September 2026. REIT. Latest period: Q2 2026 ended 30 June, released 16 July 2026.
...
Direct challenger: **Link Logistics/Blackstone and Goodman Group**. CoStar/MSCI, building-control vendors and client in-house systems are substitutes. Hyperscalers/model vendors can capture compute/interface value. Open/public records and data portability reduce exclusivity. Customers may procure outcomes and demand pass-through.
...
| freight, tariffs, supply, interest rates and development gains dominate; tenant data is contract-bound, maintenance savings may pass through, and data-center capex/power risk can increase | filing/results fact and inference | Adverse | multiple drivers |
