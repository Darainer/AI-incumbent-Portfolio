# C090 — Walmart evidence dossier

**Unreviewed agent work.** Walmart; WMT (Nasdaq, USD quote/reporting). Cutoff/retrieval 12 September 2026. Latest period: Q2 FY2027 ended 31 July, released 20 August 2026.

## Business and financial anchor

Walmart sells high-frequency consumer goods/retail services through massive distribution. Its scarce-asset hypothesis is store/club network, purchase/sell-through inventory, marketplace, membership, fulfillment and advertising data with transaction execution. AI could forecast/replenish inventory, automate fulfillment and personalize search/ads so availability, labor productivity, delivery density and high-margin revenue improve. Classical forecasting, optimization and automation already embedded in current margins remain the ordinary baseline.

Latest results reported **$187.94bn total revenue**, **$9.4bn operating income, up 28.8%, materially aided by tariff refunds**, and **FY2026 operating cash flow $41.6bn and FCF $14.9bn; H1 FY2027 capex $14.18bn**. Sources: [latest results](https://www.sec.gov/Archives/edgar/data/104169/000010416926000145/earningsreleasefy27q2.htm) and [annual report](https://stock.walmart.com/financial-information/annual-reports-and-proxies/default.aspx). FCF/adjusted measures differ from GAAP. tariff refunds drove Q2 profit; labor, capex, shrink, price investment and mix dominate, while Amazon has stronger digital/cloud interface and suppliers retain data rights. Revenue is a poor benefit denominator because product/merchandise cost passes through; operating profit and cash after inventory/capex are more relevant.
...
Direct challengers are **Amazon, Costco and Aldi**. Syndicated data, agencies, commerce platforms and generic models are substitutes/suppliers. Retailers can use their own data to bargain; consumer brands may pay retail-media tolls. Lower costs can pass through prices. An AI shopping agent can weaken brand/store interface and emphasize price.
...
| tariff refunds drove Q2 profit; labor, capex, shrink, price investment and mix dominate, while Amazon has stronger digital/cloud interface and suppliers retain data rights | results/adverse fact | Financial/adverse | multiple drivers |
...
The 5% convention is **$1.55bn annual pre-tax using FY2026 adjusted operating income of $31.0bn referenced in FY27 guidance**. Illustration: **assumed $40bn eligible labor/logistics cost × 5% efficiency × 60% realization × 40% retention − $300m = $180m**. All cost-pool, efficiency, realization, retention and run-cost inputs are assumptions. It does not count consumer savings or supplier benefit. A revenue mechanism must deduct cannibalization, discounts, ad/serving cost and incremental inventory/capex.
...
Opened 12 Sep 2026: [latest results](https://www.sec.gov/Archives/edgar/data/104169/000010416926000145/earningsreleasefy27q2.htm); [annual report](https://stock.walmart.com/financial-information/annual-reports-and-proxies/default.aspx); [privacy](https://corporate.walmart.com/privacy-security); [Amazon 10-K](https://www.sec.gov/edgar/browse/?CIK=1018724) (challenger); [Nielsen data policy](https://www.nielsen.com/legal/privacy-principles/) (syndicated-data boundary); [NIST AI RMF](https://www.nist.gov/itl/ai-risk-management-framework); [FTC AI guidance](https://www.ftc.gov/business-guidance/blog/2023/02/keep-your-ai-claims-check) (claims/adverse); [company investor hub](https://stock.walmart.com/). Controlled cohorts and commercial contracts unavailable.

Handoff [c090.json](../capsules/c090.json). Verify operating-profit denominator, data allocation and versioned store/product economics. Research-only; G2 incomplete.
