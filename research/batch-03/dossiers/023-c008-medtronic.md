...
1. **GI Genius computer-aided detection (deep vision ML).** Colonoscopy video → real-time lesion flag → higher adenoma detection → software/device revenue and installed-base defense. A 2025 non-blinded, quasi-randomized multicenter study of 795 patients reported ADR 59.1% with GI Genius versus 46.6% control; the expert subgroup was significant but the non-expert subgroup was not. NNRR was 15.1% versus 17.1% (p=.542), meaning no statistically significant difference, not equivalence or non-inferiority. This is scoped E3 evidence with design/subgroup limits, not proof of mortality benefit or Medtronic margin.
...
|---|---|---|---|---|---|
| ADR per completed colonoscopy | Concurrent conventional colonoscopy | Cleared GI Genius procedures | Pre-specified acceptable NNRR, withdrawal time and adverse events; equivalence not established | +12.5 percentage points overall in one non-blinded quasi-randomized study; non-expert subgroup not significant | Multisite production cohorts plus renewal/price data |
...
1. Medtronic, Q1 FY2027 results, 1 Sep 2026, opened 12 Sep: https://news.medtronic.com/2026-09-01-Medtronic-reports-first-quarter-fiscal-2027-results-delivers-broad-based-portfolio-performance-and-raises-fiscal-2027-guidance
2. Medtronic, FY2026 results, 3 Jun 2026, opened 12 Sep: https://www.sec.gov/Archives/edgar/data/1613103/000162828026040034/exhibit991-fy26q4earningsr.htm
