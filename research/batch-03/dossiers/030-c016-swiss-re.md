...
No clean normalized annual earnings figure was extracted. Using management's **$4.5bn 2026 net-income target** as an explicitly labeled risk-adjusted scale proxy gives a 5% hurdle of **$225m after tax**. Illustration: $2.0bn eligible expense × 15% efficiency × 60% realization × 50% retention − $80m recurring cost = **$10m after-tax-proxy benefit before tax effects**, well below hurdle and not a forecast. For underwriting, the valid test is incremental loss improvement after price, mix, reserves and catastrophes, plus capital effects. A 0.5-point apparent ratio change on an assumed $30bn eligible premium is $150m before attribution, tax and capital; the premium is an assumption, illustrating the needed magnitude rather than claiming benefit.
