...
1. **Predictive maintenance (classical ML).** Sensor and removal history → estimate failure/remaining life → schedule inspections/parts → higher availability and fewer disruptions at equal safety → service retention, fewer warranty costs or outcome fees. GE's named Collaborative Insight service is E2 deployment evidence: the company says advanced analytics continuously monitor 44,000+ commercial engines and names Fleet Monitor X, 750+ customers and maintenance recommendations. These are company-reported deployment/activity claims, not a controlled cash result.
...
| Collaborative Insight monitors 44,000+ engines and names Fleet Monitor X | OEM product fact | E2 scoped deployment | company-reported activity; no causal fleet comparator |
...
Opened 12 Sep 2026: [latest results](https://www.geaerospace.com/news/press-releases/ge-aerospace-announces-second-quarter-2026-results); [Collaborative Insight engine health monitoring](https://www.geaerospace.com/collaborative-insight) (named deployed analytics, company-reported); [annual report/results](https://www.geaerospace.com/investor-relations/annual-report); [FAA predictive maintenance guidance](https://www.faa.gov/documentLibrary/media/Advisory_Circular/AC_43-218.pdf) (regulatory quality); [EASA AI roadmap](https://www.easa.europa.eu/en/domains/research-innovation/ai) (regulatory); [Airbus Skywise](https://aircraft.airbus.com/en/services/enhance/skywise) (substitute); [Rolls-Royce IntelligentEngine](https://www.rolls-royce.com/media/our-stories/discover/2018/intelligentengine.aspx) (challenger); [company privacy](https://www.geaerospace.com/privacy) (rights); [GE-Safran CFM](https://www.cfmaeroengines.com/about/) (joint-venture scope). Contract terms and controlled outcomes were unavailable.
