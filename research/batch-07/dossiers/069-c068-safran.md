# C068 — Safran evidence dossier

**Unreviewed agent work.** Safran; ordinary stock SAF (Euronext Paris, EUR quote; EUR reporting). Cutoff/retrieval 12 September 2026. Latest period: H1 2026, published 28 July 2026.

## Business and financial anchor

Safran sells aircraft engines/equipment and long-duration aftermarket services. Installed engines create decades of shop visits, spare-parts demand and operational data, but original equipment may have lower economics to seed the service base. Defense, interiors/equipment and commercial engine exposures have different cycles. Certification, safety, engineering IP, repair networks and installed fleets are the conventional moat.

Latest results reported **€17.571bn adjusted revenue**, **€3.237bn recurring operating income (18.4% margin)**, and **€2.616bn free cash flow**. FY2025 adjusted revenue €31.189bn and recurring operating income €4.787bn. Sources: [latest results](https://www.safran-group.com/pressroom/safran-reports-its-first-half-2026-results-2026-07-28) and [annual results/report](https://www.safran-group.com/pressroom/safran-reports-excellent-financial-performance-2025-and-raises-its-2028-ambitions-2026-02-13). Adjusted/recurring measures are non-IFRS/non-GAAP and differ from consolidated statutory presentation. Engine deliveries, aftermarket mix, pricing, FX, hedges, acquisitions and supply recovery confound margin. Aftermarket volume, pricing and air traffic explain much profit growth; supply constraints, safety obligations and CFM joint-venture economics limit attribution/capture.
...
Airlines and cfm/ge partner data creates mixed ownership. CFM data/economics are shared between GE and Safran. Possession does not prove permission to pool operator, defense or partner data. Model/cloud suppliers may receive only isolated context, and exact retention/training terms are not public.

## Mechanisms and competition

1. **Predictive maintenance (classical ML).** Sensor and removal history → estimate failure/remaining life → schedule inspections/parts → higher availability and fewer disruptions at equal safety → service retention, fewer warranty costs or outcome fees. This is an E1 mechanism hypothesis here: the opened Safran financial releases do not document a named Safran production deployment or controlled fleet-level avoided-cost/cash result.
2. **Shop and supply optimization (classical ML/agentic execution).** Workscope, parts and routing data → sequence repairs/material → more engines returned per shop-day → service revenue/working-capital benefit. This remains E1 capability/hypothesis because the opened releases do not identify a versioned deployed tool; lean process, added labor/capacity and supply recovery are major confounders.
...
The incumbent challenger is **RTX/Pratt & Whitney**. Airbus Skywise and independent MRO/analytics vendors are substitutes that can own the airline interface. Airlines can demand reliability guarantees or lower service prices; suppliers can capture scarce-parts economics. Outcome-based service contracts may allow OEM capture but also make prediction errors costly.
...
| Fleet monitoring/analytics mechanism is plausible | Mechanism inference; no opened Safran deployment source | E1 | no named tool or causal fleet comparator |
...
Opened 12 Sep 2026: [latest results](https://www.safran-group.com/pressroom/safran-reports-its-first-half-2026-results-2026-07-28); [annual report/results](https://www.safran-group.com/pressroom/safran-reports-excellent-financial-performance-2025-and-raises-its-2028-ambitions-2026-02-13); [FAA predictive maintenance guidance](https://www.faa.gov/documentLibrary/media/Advisory_Circular/AC_43-218.pdf) (regulatory quality); [EASA AI roadmap](https://www.easa.europa.eu/en/domains/research-innovation/ai) (regulatory); [Airbus Skywise](https://aircraft.airbus.com/en/services/enhance/skywise) (substitute); [RTX digital](https://www.rtx.com/raytheon/what-we-do/digital) (challenger); [company privacy](https://www.safran-group.com/privacy-policy) (rights); [GE-Safran CFM](https://www.cfmaeroengines.com/about/) (joint-venture scope). Contract terms and controlled outcomes were unavailable.

Handoff [c068.json](../capsules/c068.json). Verify financial definitions, operator/JV data rights, and any fleet/shop matched outcome. Research-only; G2 incomplete.
