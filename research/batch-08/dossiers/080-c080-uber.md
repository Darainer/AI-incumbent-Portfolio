...
Five percent of Q2 GAAP operating income is **$95m for the quarter**; this same-period screen is not annualized. Illustration: **assumed $20bn eligible incentive/support/loss pool × 2% improvement × 70% realization × 50% retention − $100m cost = $40m**. Every cost-pool/efficiency/realization/retention/run-cost input is assumed. Customer savings are not company cost; released capacity cannot be counted again as added revenue. Existing ML expense and benefit remain in baseline.
